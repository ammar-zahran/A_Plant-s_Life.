...
class SelfCardSeller extends StatefulWidget {
  final SelfItemSeller item;

  const SelfCardSeller({
    Key? key,
    required this.item,
  }) : super(key: key);

  @override
  _SelfCardSeller createState() => _SelfCardSeller();
}

class _SelfCardSeller extends State<SelfCardSeller> {
  void initState() {
    super.initState();
  }
